...
- Tokenização: `tokenizers` (HF) com o vocab embutido no binário. Chunking: memórias > 512 tokens são divididas com overlap de 64 e agrupadas por `parent_id` no recall (devolver a memória inteira, não o chunk).
